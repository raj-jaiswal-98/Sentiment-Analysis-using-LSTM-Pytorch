...
def predict_sentiment(text):
    ...
    pred = ''
    if prob > 0.5:
        pred = f"This Statement seems Positive 🤗 to us, with probability of {prob}"
    else:
        pred = f"This Statement seems Negative 😤 to us, with probability of {1-prob}"
    return pred


# Streamlit UI

st.title('Analyse the Sentiment of any Statement 😤/🤗')

text = st.text_input("Enter your statement/review here!!")
